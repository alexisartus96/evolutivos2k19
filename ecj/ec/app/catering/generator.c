...
typedef short ttype;   /* type of variable */
...
void showitems(item *f, item *l, stype c, int S)
{
  item *i;
  stype ps, ws;
  FILE *out;
...
int main(int argc, char *argv[])
{
  ...
  printf("This code is run by issuing the command:\n");
  printf("  generator n r type i S\n");
  printf("where n: number of items\n");
  printf("      r: range of coefficients\n");
  printf("      t: 1=uncorr., 2=weakly corr., 3=strongly corr., 4=subset sum\n");
  printf("      i: instance number\n");
  printf("      s: number of item types\n\n");
