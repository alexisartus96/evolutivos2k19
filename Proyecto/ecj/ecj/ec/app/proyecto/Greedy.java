...
public class Greedy {
	...
	private static double duracionTurno = 19700.0;
	private static double capacidadCamion = 400;
	private static double tiempoParada= 120.0;
	private static String ruta_tiempos = "/home/andres/Escritorio/Fing/evolutivos2k19/Proyecto/ecj/ecj/ec/app/proyecto/tiempos_cordon.in";
	private static String ruta_generator = "/home/andres/Escritorio/Fing/evolutivos2k19/Proyecto/ecj/ecj/ec/app/proyecto/capacidad_inicial_cordon.in";
	private static String ruta_personas_contenedor = "/home/andres/Escritorio/Fing/evolutivos2k19/Proyecto/ecj/ecj/ec/app/proyecto/personas_cont_cordon.in";
...
//					double incremento=(duracionTurno-tiempoCamiones[i]+tiempo-tiempoParada)*Double.valueOf(contenedores[contenedor][2]);
					double incremento=(capacidadActual(i, contenedor, mejorContenedor[i][3]>0));
					double basura= incremento;
		...
		for (List<Integer> list : contenedoresVisitados) {
			...
			for (Integer contenedor : list) {
				if(contenedor<cantContenedores) {
					System.out.println("prueba["+aux2+"]="+contenedor+";");//+"#"+capacidadContenedores[contenedor]+"+"+tiempos[aux][contenedor]+";";
					aux2++;
...
//	}
	...
	public static double getTiempo(int camion, int contenedor) {
		return tiempos[ubicacionCamion[camion]][contenedor] + tiempoParada;
	}
	public static double getTiempoPorDeposito(int camion, int contenedor) {
		return tiempos[ubicacionCamion[camion]][cantContenedores]+tiempos[cantContenedores][contenedor] + tiempoParada;
	}
	
	public static double getIncrementoDirecto(int camion, int contenedor) {
		return (duracionTurno-tiempoCamiones[camion]+getTiempo(camion, contenedor)-tiempoParada)*Double.valueOf(contenedores[contenedor][2]);
	}
	
	public static double getIncrementoPorDeposito(int camion, int contenedor) {
		return (duracionTurno-tiempoCamiones[camion]+getTiempoPorDeposito(camion, contenedor)-tiempoParada)*Double.valueOf(contenedores[contenedor][2]);
	}
